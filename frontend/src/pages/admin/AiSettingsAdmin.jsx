  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-8">
      <div className="flex items-center gap-3 mb-1">
        <Cpu size={20} className="text-[#b33b62]" />
            ...
            return (
              <label
                ...
                className={`flex items-start gap-3 rounded-xl border p-3 cursor-pointer transition-colors ${
                  active ? 'border-[#b33b62] bg-[#b33b62]/5' : 'border-gray-200 hover:bg-gray-50'
                } ${vendor.keyConfigured ? '' : 'opacity-60'}`}
              >
                <input
                  type="radio"
                  name="provider"
                  className="mt-1 accent-[#b33b62]"
                  checked={active}
                ...
                <span className="min-w-0 flex-1">
                  <span className="flex flex-wrap items-center gap-2">
                    ...
                    {vendor.keyConfigured ? (
                      <span className="inline-flex items-center gap-1 text-[10px] uppercase tracking-wide text-[#b33b62]">
